						...
						<div class="row">
							...
							<div class="col-lg-6 col-md-6 col-sm-12">				
								<div class="input-box">	
									...
									<select id="notification-type" name="notification-type" class="form-select" data-placeholder="<?php echo e(__('Select Notification Type')); ?>:">			
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">						
								<div class="input-box">	
									...
									<select id="notification-action" name="notification-action" class="form-select" data-placeholder="<?php echo e(__('Select User Action Type')); ?>:">			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/infiniteideas/public_html/resources/views/admin/notification/create.blade.php ENDPATH**/ ?>